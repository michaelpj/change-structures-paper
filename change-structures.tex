...
\begin{proof}
  ...
  Then
  \begin{align*}
    &\ev((f, a) \cplus (\change{f}, \change{a}))\\
    =&\ev((f \cplus \change{f}, a \cplus \change{a}))\\
    =&(f \cplus \change{f})(a \cplus \change{a}) \tag{definition of $\ev$}\\
    =&f(a \cplus \change{a}) \cplus \change{f}(a \cplus \change{a})\tag{definition of $\changes{(A \rightarrow B)}$}\\
    =&f(a) \cplus \derive{f}(a, \change{a}) \cplus \change{f}(a \cplus \change{a})\tag{$f$ is differentiable}\\
    =&f(a) \cplus \left[ \derive{f}(a, \change{a}) \splus \change{f}(a \cplus \change{a})\right]\tag{monoid action}\\
    =&\ev(f, a) \cplus \derive{\ev}((f, a), (\change{f}, \change{a}))\tag{definition of $\derive{\ev}$}\\
  \end{align*}
  ...
  Then
  \begin{align*}
    &\curry{f}(a \cplus \change{a})\\
      =&\lambda b. f((a \cplus \change{a}, b))\tag{definition of $\curry{f}$}\\
      =&\lambda b. f((a, b) \cplus (\change{a}, \mzero))\\
      =&\lambda b. f((a, b)) \cplus \derive{f}((a, b), (\change{a}, \mzero))\tag{since $f$ is differentiable}\\
      =&(\lambda b. f((a, b))) \cplus (\lambda b. \derive{f}((a, b), (\change{a}, \mzero)))\tag{definition of $\changes{(A \rightarrow B)}$}\\
      =&\curry{f}(a) \cplus \derive{\curry{f}}(a, \change{a})\tag{definition of $\derive{\curry{f}}$}\\
  \end{align*}
