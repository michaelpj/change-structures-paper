...
And then we have reached a fixpoint, so we are done.
...
extensions (\cref{sec:nonRecursiveDatalog}, \cref{sec:recursiveDatalog}). This provides the world's first incremental
