...
\begin{itemize}
  ...
  \item A description of the algebraic properties of change structures (\cref{sec:algebra}), including
  ...
  \item A description of the properties of change structures over posets
    (\cref{sec:moreStructures}), including theorems that characterize the range of
...
Given change structures and functions between them, we have a natural notion of a derivative, following \textcite{cai2014changes}:
...
\label{thm:fixpointDiff}
  ...
  it satisfies \cref{eqn:fixcondition}.
...
there is nothing preventing a ``plugin'' for \citeauthor{cai2014changes}'s system providing the
...
\textcite{bancilhon1986amateur}, although as far as we know nobody has since
