...
\todomario{I find this footnote a bit confusing - maybe remove?}
...
\footnote{The idea of using an approximation
...
This is known (see \cite{gupta1993maintaining} and successors),
...
coproducts in this category. Furthermore, \cref{theorem:functionalCAct} can be
read as showing that complete change actions form an exponential ideal in $\cat{CAct}$.

There is a great deal of work to be done exploring a categorical approach to the
material in this paper. $\cat{CAct}$ is equivalent to $\cat{PreOrd}$, and there
are useful subcategories of $\cat{CAct}$ which are Cartesian closed.
