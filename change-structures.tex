...
about this when applying \cref{thm:diffFP}, but we it will be a requirement to
apply \cref{thm:leastFixpointDiff}.
...
\label{thm:concreteDatalog}
  ...
  \downdiff R &\defeq \downdiff R_j \tag{where $\downdiff R_j$ is the second component of the $j$the element of $\bothchanges$}\\
...
we have a different notion of function changes, so the result is inapplicable as
stated. In addition, we have a somewhat different set of conditions, in particular we
