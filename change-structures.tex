...
\ifproofs
\begin{proof}
  $\nextiter$ is continuous, since $\cplus$ and $\derive{f}$ are. 
  \begin{itemize}
    \item[ ]$\iter_f(n) = \pi_1 (\nextiter_f^n(\bot))$
    \item[$\Rightarrow$]$\sqcup_{n \in \NN} \iter_f(n) = \sqcup_{n \in \NN} \pi_1 (\nextiter_f^n(\bot))$
    \item[$\Rightarrow$]\{ $\pi_1$ is continuous \}\\
      $\sqcup_{n \in \NN} \iter_f(n) = \pi_1 \sqcup_{n \in \NN} (\nextiter_f^n(\bot))$
    \item[$\Rightarrow$]\{ $\nextiter$ is continuous \}\\
      $\lfp(\iter_f) = \sqcup_{n \in \NN} \iter_f(n) = \pi_1 (\lfp(\nextiter_f))$
  \end{itemize}
\end{proof}
\fi
...
\begin{prop}[Derivatives of the iteration map with respect to $f$]
...
\ifproofs
\begin{proof}
  We can write our mutually recursive definitions of $\derive{\iter_n}$ and
  $\iter_n$ as a recurrence relation:
