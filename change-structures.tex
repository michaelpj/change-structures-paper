...
This kind of structure is well-known - it describes an set action. It is
...
$a$. Now we are interested in evaluating it after some change to $a$,
...
\rightarrow \changes B$, which tells us how to change $f(a)$ given a change to $a$.

We call this a \emph{derivative} of a function.
