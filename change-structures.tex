...
is the \emph{differential $\lambda$-calculus}. This is a higher-order, simply-typed
...
studied in depth, and the relationship between these and change actions
is the subject of ongoing work.

\subsection{Higher-order automatic differentiation}

Automatic differentiation is a technique that allows for efficiently computing
the derivative of arbitrary programs, with many applications in scientific computing
and machine learning. In recent times, this technique has been successfully
applied to higher-order languages, but a general theoretical framework for it is still
...
be based. We believe our notion of change actions is intrinsically better suited
to this purpose than change structures, since one can easily give them a
geometric reading (by interpreting $\cstr{A}$ as an Euclidean module and $\changeS{A}$
...
\begin{proof}
\label{prf:pointwiseChangeAction}
