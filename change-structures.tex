...
\begin{defn}
  ...
  \end{displaymath}
  I.e. $\sigma_\Gamma$ restricts a named tuple over \lochanged{$\Gamma \cup \Sigma$} into a tuple over $\Gamma$
  with the same values for the names in $\Gamma$.
  %We will often apply $\sigma_\Gamma$ elementwise to sets of tuples.
\lochanged{By abuse of notation, we denote the elementwise extension of $\sigma_\Gamma$ to sets of tuples also as $\sigma_\Gamma$.}
\end{defn}
...
\begin{defn}
  ...
  \lochanged{$\Rel_\Gamma^n$ to $\Rel_\Gamma$}.
  \begin{displaymath}
