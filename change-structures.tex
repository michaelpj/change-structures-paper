...
This natural formulation amounts to recursion through an \emph{universal}
...
the following definition provides one:\footnote{This rule should be read as: we
...
Even if we restrict ourselves to the differential functions between $\cstr{A}$
...
rather than bag semantics (the same approach of finding derivatives
...
\todomario{I think if we need more space we could cut quite a bit of stuff from the related work section}
