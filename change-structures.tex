...
\todomario{Tweak these paragraphs}
The main avenue for future theoretical work is the categorical structure of
change actions. This has begun to be explored by the authors in \cite{alvarez2019changeactions}.

These generalizations would allow us to extend the theory of change actions in
multiple different directions, such as synthetic differential geometry and
domain theory. This is the subject of ongoing work by the authors.
