...
is a monoid action: $(a \doubleplus b) \doubleplus c = a \left( b \doubleplus c \right)$.
...
\begin{align*}\label{eqn:updiffTreeP}
...
This is still not especially easy to compute. If we naively compute it, the
...
While we can't give a precise derivative, as in the earlier example
\cref{eqn:updiffTreeP},
we can still provide a guard that prevents us from having to re-evaluate in all cases. 
