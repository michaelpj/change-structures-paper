...
Our argument is that change actions provide a good model for incremental
...
Boolean algebras also have concrete definitions for unique maximal and minimal
derivatives, giving them the usual preorder based on implication.\footnote{The change
