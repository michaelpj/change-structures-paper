...
maximal and minimal minus operators are representable as pairs of Datalog
formulae, and so we can reuse an existing Datalog formula evaluator.\footnote{
...
specifics of the evaluation engine. Here is one possibility.\footnote{These are
  the derivatives actually in use at Semmle. We arrived at them by starting with the
