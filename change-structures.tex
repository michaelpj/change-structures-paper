...
sets $\changes_aA, \changes_aB$, much like in Cai et al.'s original presentation.

\subsection{Change actions on arbitrary categories}

\todomario{If this paragraph goes before the subsection title, it makes it look
  like it's part of the 2-category section}
...
Cai et al.'s ILC. Our fixpoint theorems are proven over dcpos
