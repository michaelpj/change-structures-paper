...
$\cstr{A} \rightarrow_\cplus \cstr{B}$ to distinguish it from the set of usual set-theoretic funcitons
...
\begin{defn}[Pointwise functional change actions]
  ...
  $\cstr{A} \Rightarrow_{pt} \cstr{B}$, when it is defined,
...
\label{prop:evDerivatives}
  ...
  $\cstr{A} \Rightarrow_{pt} \cstr{B}$ is well defined, and let
