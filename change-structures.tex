...
The requirements of this theorem may seem onerous. However, when working with
least fixpoints, the setting is usually cpos that satisfy the ACC with monotone
...
\end{prop}
\begin{proof}
  Largely trivial (see \ref{prop:monotoneContinuous}), but we give a proof of the final item.
