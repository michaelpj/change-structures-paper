...
We will also consider \textit{continuous} functions between lattices, which we
will consider to be those that preserve all suprema.
...
\label{prop:supDerivatives}
  ...
  in its second argument. Then for any directed set $D$ of derivatives of $f$, $\bigvee
...
\begin{prop}
  ...
  \begin{itemize}
    ...
    \item $\changes{A}$ be ordered according to $\changeOrder$, and a complete lattice
...
MPJ: this paragraph makes me sad
