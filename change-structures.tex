...
\label{prf:pointwiseChangeActions}
  ...
  and $\curry{f} : C \rightarrow \exponential{\cstr{A}}{\cstr{A}}$ its corresponding curried version:
  \begin{align*}
  ...
  \end{align*}
  Then the funciton $\lambda a . \derive{f}((c, \change{c}), (a, 0))$ is a derivative for $\curry{f}$,
