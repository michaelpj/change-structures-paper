...
\label{prop:exponentials}
  ...
  to be \emph{pointwise $\reachOrder$-increasing} iff, for every $f : \cstr{A} \difffunc \cstr{B}$
...
\begin{proof}
  ...
  \item[=]$\lambda b . f(a, b) \cplus \derive{f}((a, b), (\change{a}, 0))$
