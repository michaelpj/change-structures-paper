...
Consider the following classic Datalog program\footnote{See \autocite[][part
  D]{abiteboul1995foundations for an introduction to Datalog.}},
...
\todompj{Not sure if this is actually clearer than the abstract version}
\begin{align*}
