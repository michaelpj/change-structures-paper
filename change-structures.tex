...
First, it is possible to define a category $\cat{CAct}$ of change actions and differentiable
...
It can be shown that the category $\cat{CAct}$ is equivalent to the category $\cat{PreOrd}$ of
preorders and monotone functions, which has the important consequence that $\cat{CAct}$ is
Cartesian closed and has all finite limits. This equivalence, however, isn't very helpful
...
There is also an interesting connection between the category $\cat{CAct}$ and the 2-category 
