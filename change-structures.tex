...
\begin{proposition}[name=Products, restate=products]
  \label{prop:products}
...
\begin{proposition}[name=Disjoint unions, restate=disjointUnions]
...
\begin{proposition}[name=Boolean algebra change actions, restate=lsuperpose]
...
\begin{proposition}[name=Boolean algebra kernels, restate=booleanAlgebraKernels]
...
\begin{theorem}[name=Concrete Datalog formula derivatives, restate=concreteDatalog]
...
\begin{proposition}[name=Boolean algebra continuity, restate=booleanAlgebraContinuous]
...
\begin{proposition}[name=Factoring of fixpoints, restate=factoringFixpoints]
...
\begin{proposition}[name=Derivative of the iteration map with respect to $n$, restate=iterDerivativesN]
...
\begin{theorem}[name=Incremental computation of least fixpoints, restate=fixpointIter]
...
\begin{theorem}[name=Pseudo-derivatives of fixpoints, restate=fixpointPseudoDerivatives]
...
\begin{proposition}[name=Derivative of the iteration map with respect to $f$, restate=iterDerivativesF]
...
\begin{theorem}[name=Derivatives of least fixpoint operators, restate=leastFixpointDerivatives]
